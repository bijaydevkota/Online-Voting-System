    ...
    <div className="bg-gray-100">
     ...
     <div className="flex gap-4 pr-4 pl-4 py-4 mt-24">
        <div className="flex flex-col text-center w-4/12 mx-auto bg-gradient-to-b from-sky-300 via-sky-400 to-sky-600 p-6 text-white rounded-xl shadow-sm">
          ...
          <button className="bg-gradient-to-r from-red-500 via-red-600 to-red-700 rounded text-white mt-6 w-4/12 mx-auto p-2">Learn More</button>
        </div>
...
Using methods like unique voter IDs, passwords, or biometric authentication.
          ...
          <button className="bg-gradient-to-r from-red-500 via-red-600 to-red-700 rounded text-white mt-4 w-4/12 mx-auto p-2">Learn More</button>
        </div>
